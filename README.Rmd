...
{oncokbR} is now also apart of the [gnomeverse](https://mskcc-epi-bio.github.io/genomeverse/), which is a collection of R packages that are designed to work together seamlessly to create reproducible clinico-genomic analysis pipelines.
